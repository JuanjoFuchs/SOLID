...
namespace ComercioElectronico.Tests
{
    ...
    public class CarritoCalcularTotalDeberiaRetornar
    {
        ...
        [Test]
        public void DosCuandoTieneSeisQueCuestanCuarentaCentavos()
        {
            _carrito.Agregar(new Producto() { Unidad = "GOLOSINA", Precio = 0.4m, Cantidad = 6 });
            Assert.AreEqual(2m, _carrito.CalcularTotal());
        }
    }
}
